...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase">Laporan Perubahan Harga Barang</span></div>
		<div class="tools">
	...
	<div class="portlet-body form">
		<form action="./export/laporan_harga_barang.php" method="post" name="form1" class="form-horizontal form-bordered" target="_BLANK">
			<div class="form-body">
				<div class="form-group">
					<label class="col-md-2 control-label">Periode Perubahan :</label>
					<div class="col-md-3">
