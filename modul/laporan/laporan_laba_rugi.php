...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase">Laporan Laba Rugi</span></div>
		<div class="tools">
	...
	<div class="portlet-body form">
		<form action="./export/laporan_laba_rugi.php" method="post" name="form1" class="form-horizontal form-bordered" target="_BLANK">
			<div class="form-body">
