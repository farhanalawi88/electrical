<?php
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
			$kodeBaru	= buatKode("ms_expedisi", "");
			$qrySave=mysql_query("INSERT INTO ms_expedisi SET kode_expedisi='$kodeBaru', 
															nama_expedisi='$txtNama', 
								  							keterangan_expedisi='$txtKeterangan',
															status_expedisi='$cmbStatus'") or die ("Gagal query".mysql_error());
			if($qrySave){
				$_SESSION['info'] = 'success';
				$_SESSION['pesan'] = 'Data expedisi berhasil ditambahkan';
...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase">Form Penambahan Expedisi</span></div>
		<div class="tools">
